/* eslint-disable */
// TODO : index.html file has to be copied to WEB_INF/index.html on deploy task
module.exports = function (grunt) {
    ...
    var taskConfig = {
        ...
        /**
         * Grunt constant task to separate configs of prod/dev/staging
         */
        ngconstant: {
            options: {
                name: 'config',
        ...
        concat: {
            ...
            compile_js: {
                ...
                dest: '<%= prod_build_dir %>/<%= pkg.name %>-<%= pkg.version %>.js'
            }
        },
